...
Partial Public Class PassChange
    
    '''<summary>
    '''Control formPassChange1.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents formPassChange1 As Global.System.Web.UI.HtmlControls.HtmlForm
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents hyperPass As Global.System.Web.UI.WebControls.HyperLink
End Class
